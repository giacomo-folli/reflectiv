    ...
    <div class="modal">
      ...
      <div class="modal-content">
        ...
        <ul class="feature-list">
          ...
          <li>{DateTime.local(parseInt(selectedYear), parseInt(selectedMonth)).daysInMonth} days (or appropriate number for the month)</li>
        ...
        <p class="note">
          Note: This is a preview of what will be generated. The actual PDF 
          will contain tailored questions based on the month and seasonal themes.
        </p>
      </div>
